...
final class Config
{
     ...
     */
    const ASYNC_WORKER_ACTION_NAME = 'async_worker';

    /**
     * The name of the secret key for the async worker.
     */
    const ASYNC_WORKER_SECRET_KEY_NAME = 'async_worker_secret_key';

    /**
     * The name of the cron event for the scheduler.
     */
    const SCHEDULER_CRON_EVENT_NAME = 'themeum_framework_scheduler_cron_event';

    /**
     * The name of the cron event for the cleanup.
     */
    const SCHEDULER_CRON_CLEANUP_EVENT_NAME = 'themeum_framework_scheduler_cleanup_event';
     ...
     * total: 0.05s
     */
    const JOB_EXECUTION_GAP_IN_MICROSECOND = 50000;

    /**
     * The interval for the cron event.
     */
    const CRON_EVENT_INTERVAL = 'every_minute';
}
